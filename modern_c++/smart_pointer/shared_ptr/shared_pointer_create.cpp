...
int main() {
    ...
    std::shared_ptr<Entity> p_entity2(new Entity("Benjamin"));
    p_entity2->print_info();

    // Method 3: create by "std::make_shared"
    std::shared_ptr<Entity> p_entity3 = std::make_shared<Entity>("Chris");
    p_entity3->print_info();

    // Method 4: create by "std::make_shared" with declaration "auto"
    auto p_entity4 = std::make_shared<Entity>("Daniel");
