...
@0 = private unnamed_addr constant [20 x i8] c"p.x = %d, p.y = %d\0A\00", align 1
...
entry:
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @0, i32 0, i32 0), i32 %x, i32 %y)
  ret i32 0
}
