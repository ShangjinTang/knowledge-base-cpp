...
@0 = private unnamed_addr constant [23 x i8] c"(transformer 10) = %d\0A\00", align 1
...
entry:
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @0, i32 0, i32 0), i32 %3)
